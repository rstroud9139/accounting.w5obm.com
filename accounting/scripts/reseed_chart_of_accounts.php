...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $results = accounting_reseed_truncate($accConn, $tablesToTruncate);
        $ledgerResult = accounting_reseed_seed_accounts($accConn, $accountsSeed, $userId);
