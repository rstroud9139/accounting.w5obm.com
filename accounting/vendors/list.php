...
$vendorFilterCollapseId = 'vendorFilterCollapse';
        ...
        <div class="row">
            <div class="col-lg-3 mb-4">
                <?php if (function_exists('accounting_render_workspace_nav')): ?>
                    <?php accounting_render_workspace_nav('vendors'); ?>
                <?php endif; ?>
            </div>
                ...
                <div class="card shadow mb-4 border-0">
                    <div class="card-header bg-primary text-white border-0 d-flex flex-wrap justify-content-between align-items-center gap-2">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button type="button" class="btn btn-light btn-sm text-primary" data-bs-toggle="collapse" data-bs-target="#<?= $vendorFilterCollapseId ?>" aria-expanded="true" aria-controls="<?= $vendorFilterCollapseId ?>">
                                <i class="fas fa-chevron-down me-1"></i>Toggle Filters
                            </button>
                        </div>
                    </div>
                    <div class="card-body p-0 collapse show" id="<?= $vendorFilterCollapseId ?>">
