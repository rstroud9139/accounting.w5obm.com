            ...
            <div class="card shadow-sm h-100 account-type-card" data-type="<?= strtolower($type) ?>">
                <div class="card-body text-center">
                    <div class="account-type-icon mb-2">
                        <i class="fas fa-<?php
                        switch($type) {
                            case 'Asset': echo 'coins text-success'; break;
                            case 'Liability': echo 'credit-card text-danger'; break;
                            case 'Equity': echo 'balance-scale text-info'; break;
                            case 'Income': echo 'arrow-up text-success'; break;
                            case 'Expense': echo 'arrow-down text-warning'; break;
                        }
                        ?> fa-2x"></i>
                    </div>
    ...
    <div class="card-body" id="filterPanel" style="display: none;">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <?php if ($can_add): ?>
                <a href="/accounting/ledger/setup_standard.php" class="btn btn-outline-info">
...
.account-row.level-0 { border-left-color: #007bff; }
.account-row.level-1 { border-left-color: #6c757d; }
.account-row.level-2 { border-left-color: #28a745; }

.account-indent {
    padding-left: 0;
}
.account-indent.level-1 { padding-left: 2rem; }
.account-indent.level-2 { padding-left: 4rem; }
.account-indent.level-3 { padding-left: 6rem; }
...
@media (max-width: 768px) {
    .account-indent.level-1 { padding-left: 1rem; }
    .account-indent.level-2 { padding-left: 2rem; }
    .account-indent.level-3 { padding-left: 3rem; }
