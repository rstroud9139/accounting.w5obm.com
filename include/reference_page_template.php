...
<head>
    ...
    <style>
        ...
        :root {
            --primary-blue: <?= htmlspecialchars(get_site_setting('primary_blue', $heroDefaults['gradient_start'] ?? 'var(--primary-blue)'), ENT_QUOTES, 'UTF-8'); ?>;
            --secondary-blue: <?= htmlspecialchars(get_site_setting('secondary_blue', $heroDefaults['gradient_end'] ?? 'var(--secondary-blue)'), ENT_QUOTES, 'UTF-8'); ?>;
            --accent-gold: <?= htmlspecialchars(get_site_setting('accent_gold', 'var(--accent-gold)'), ENT_QUOTES, 'UTF-8'); ?>;
        ...
        .hero-section::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, var(--hero-overlay-from) 0%, var(--hero-overlay-to) 100%);0%, var(--hero-overlay-to) 100%);
            z-index: 1;
            opacity: .85;
        }
